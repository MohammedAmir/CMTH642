...
# 6. Create a script for a HealthCheck function to detect unhealthy foods. 
```{r}
...
# 8. How many foods in the USDAcle an data frame fail the HealthCheck? 
```{r}
...
# 9. Write final data frame to csv file. 
```{r}
